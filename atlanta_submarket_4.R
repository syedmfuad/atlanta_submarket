...
datanew$prob <- colnames(datanew[, c(42:45)])[apply(datanew[, c(42:45)],1,which.max)]
...
data4 %>% get_summary_stats(salesprice, ENGMeanScaleScore15, calcacres, median_income, age, pct_white, pct_black, 
                            pct_collegeDegree, median_house_value, HHsize, sqft, type = "mean_sd") -> sumdata4
...
datanew$prob <- colnames(datanew[, c(43:46)])[apply(datanew[, c(43:46)],1,which.max)]
...
data3 %>% get_summary_stats(salesprice, ENGMeanScaleScore15, calcacres, median_income, age, pct_white, pct_black, 
                            pct_collegeDegree, median_house_value, HHsize, type = "mean_sd") -> sumdata3
data4 %>% get_summary_stats(salesprice, ENGMeanScaleScore15, calcacres, median_income, age, pct_white, pct_black, 
                            pct_collegeDegree, median_house_value, HHsize, type = "mean_sd") -> sumdata4
